...
public class ChessMatch {
	...
	private Piece makeMove(Position source, Position target) {
		...
		if(capturedPiece != null) {
			...
			this.capturesPieces.add(capturedPiece);
		}
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		if(capturedPiece != null) {
			...
			this.capturesPieces.remove(capturedPiece);
	...
	private boolean testCheck(Color color) {
		...
		List<Piece> oppenentPieces = this.piecesOnTheBoard.stream().filter(x -> ((ChessPiece)x).getColor() == this.opponent(color)).collect(Collectors.toList());
